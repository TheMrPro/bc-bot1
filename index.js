  ...
  client.on("message", message => {
   ...
   client.on("message", message => {
    if (message.content === "v!invite") {
     const embed = new Discord.RichEmbed()
         .setColor("RANDOM")
         .addField('Broadcast', `https://discordapp.com/api/oauth2/authorize?client_id=521323444852490240&permissions=8&scope=bot`)
...
client.on('ready', () => {
    console.log(`Logged in as ${client.user.tag} !`);
          client.user.setActivity("#Venus | v!help",{type: 'WATCHING'});
